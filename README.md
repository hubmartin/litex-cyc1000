...
- [LiteX SoC](litex_cyc1000/README.md)
...
are excluded from Git. The build scripts currently use a local Quartus
installation; see each project's README and scripts for build and load details.
